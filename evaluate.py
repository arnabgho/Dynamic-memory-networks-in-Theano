...
parser.add_argument('--vqa_results',type=str,default="Results/vqa_result.json",help="The VQA result file")
...
ix_to_ans=dmn.json_dict["ix_to_ans"]
...
def do_epoch(mode, epoch, skipped=0):
    ...
    file=open(args.vqa_results,"w")
    json.dump(json_results_data,file,indent=2)
else:
